	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			<tr>
				...
				<td><a class="btn btn-warning" href="<?php echo WEBROOT; ?>Uploads/edit/<?php echo $value['id'] ?>" role="button">Modifier</a></td>
				<td><a class="form-control btn btn-danger" href="<?php echo WEBROOT; ?>Uploads/delete/<?php echo $value['id'] .'/' .$value['name'] ?>" role="button">Supprimé</a></td>
				</td>
			</tr>
			<?php } ?>
		</tbody>
